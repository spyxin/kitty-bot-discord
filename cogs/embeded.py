...
class Embeded(commands.Cog):
    ...
    async def sendembed(self, ctx):
        embeded_msg = discord.Embed(title="about", description="about the bot", color=discord.Color.blurple())
        embeded_msg.set_thumbnail(url="https://i.pinimg.com/736x/bd/1c/fc/bd1cfcbbd82fc71c53a24b7d090fc5d5.jpg")
        embeded_msg.add_field(name="About me:", value="i'm a bot made by @aromaks", inline=False)
